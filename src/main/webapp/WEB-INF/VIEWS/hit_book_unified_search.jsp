...
<nav class="navbar navbar-light" style="background-color: #b79e4c;">
    <div class="container">
        <a class="btn" style="background-color: #a57534; color: #efd690;" href="/book/unified_search">자료 검색</a>

        <div class="dropdown show">
            <a class="btn dropdown-toggle" style="background-color: #a57534; color: #efd690;" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                신청 / 참여
            </a>
