...
<div class="container mt-5">
    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <article>
                ...
                <header class="mb-4">
                    ...
                    <!-- Post categories -->
                    <div class="badge bg-secondary text-decoration-none link-light">ISBN
                        : ${goodDTO.goodISBN}</div>
                </header>
        ...
        <div class="col-lg-4 mb-5">
            ...
            <img class="card-img-top" src="/bookImageStorage/${goodDTO.goodImage}"
                 alt="Card image cap">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 h-100 text-center text-lg-start my-auto">
                ...
                <p class="text-muted small mb-4 mb-lg-0">&copy; 작은 도서관</p>
            </div>
