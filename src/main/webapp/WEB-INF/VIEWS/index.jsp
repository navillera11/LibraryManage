...
<nav class="navbar navbar-expand-lg bg-light static-top ">
    <div class="container px-5">
        <%
            // 세션값 가져오기
            String id = (String) session.getAttribute("loginMemberName");
            if (id == null) {%>
        <a class="navbar-brand" href="/">작은 도서관</a>
        <%} else {%>
        <a class="navbar-brand" href="/member_index">작은 도서관</a>
        <%
            }
        %>
...
<!-- Navigation-->
<nav class="navbar navbar-light" style="background-color: #b79e4c;">
    <div class="container">
        <a class="btn" style="background-color: #a57534; color: #efd690;"
           href="/book/unified_search">자료 검색</a>

        <div class="dropdown show">
            <a class="btn dropdown-toggle" style="background-color: #a57534; color: #efd690;"
        ...
        <div class="row justify-content-center">
            <div class="col-xl-6">
                <div class="text-center text-white">
                    <!-- Page heading-->
                    <h1 class="mb-5" style="text-shadow: 4px 4px 11px black;">작은 도서관에 어서오세요.</h1>
                    </form>
                </div>
            </div>
        </div>
                ...
                <div class="card h-100">
                    ...
                    <div class="card-footer">
                        <a class="btn btn-primary btn-sm"
                           href="/board/board_detail?boardID=${boardDTO.boardID}">More Info</a>
                    </div>
                </div>
            </div>
        </c:forEach>
                    ...
                    <div class="card-body p-10">
                        ...
                        <ul class="list-unstyled mb-4">
                            ...
                            <c:forEach var="noticeDTO" items="${noticeList}">
                                <li class="mb-2"><i class="bi bi-check text-primary"></i><a
                                        href="/notice/notice_detail?noticeID=${noticeDTO.noticeID}">${noticeDTO.noticeTitle}</a>
                                </li>
                            </c:forEach>
                        </ul>
                        <div class="d-grid">
            ...
            <div class="col-lg-6 col-xl-6">
                <div class="card mb-5 mb-xl-0">
                    <div class="card-body p-10">
                        <div class="mb-3">
                                <span class="display-4 fw-bold"> <i
                                        class="bi bi-star-fill text-warning"></i>신간 도서
                                </span>
                        </div>
                        <ul class="list-unstyled mb-4">
                            <c:forEach var="bookDTO" items="${bookList}">
                                <li class="mb-2"><i class="bi bi-check text-primary"></i>
                                    <strong>
                                        <a class="bi text-primary"
                                           href="/book/book_detail?bookISBN=${bookDTO.bookISBN}&bookGenre=${bookDTO.bookGenre}">${bookDTO.bookTitle}</a>
                                    </strong>
                                </li>
                            </c:forEach>
                        ...
                        <div class="d-grid">
                            <a class="btn btn-outline-primary"
                               href="/book/new_unified_search">더보기</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 h-100 text-center text-lg-start my-auto">
                ...
                <p class="text-muted small mb-4 mb-lg-0">&copy; 작은도서관 </p>
            </div>
            <div class="col-lg-6 h-100 text-center text-lg-end my-auto">
                <ul class="list-inline mb-0">
                    <li class="list-inline-item me-4"><a href="#!"><i class="bi-facebook fs-3"></i></a>
                    </li>
                    <li class="list-inline-item me-4"><a href="#!"><i
                            class="bi-twitter fs-3"></i></a></li>
                    <li class="list-inline-item"><a href="#!"><i class="bi-instagram fs-3"></i></a>
                    </li>
                </ul>
            </div>
        </div>
