...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container px-5">
            <a class="navbar-brand" href="/admin_index">작은 도서관 관리자 페이지</a>
    ...
    <div class="container px-4 px-lg-5">
        ...
        <div class="row gx-4 gx-lg-5 align-items-center my-5">
            ...
            <div class="col-lg-5">
                <h1 class="font-weight-light">작은 도서관<br /> Admin Page</h1>
                            ...
                            <div class="card-group">
                                <div class="card" style="width: 18rem;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">작은도서관 도서관리 시스템에<br /> <b>도서를 추가/삭제</b>하는 기능을 이용합니다.</p>
                                ...
                                <div class="card" style="width: 18rem;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">작은도서관 도서관리 시스템에<br /> <b>도서의 정보를 수정</b>하는 기능을 이용합니다.</p>
                                ...
                                <div class="card" style="width: 18rem;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">작은도서관 도서관리 시스템에<br /> <b>연체된 도서 정보를</b> 보는 기능을 이용합니다.</p>
                            ...
                            <div class="card-group">
                                <div class="card" style="width: 18rem;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">작은도서관 도서관리 시스템에<br /> <b>공지사항 게시판</b>을 관리합니다.</p>
                                ...
                                <div class="card" style="width: 18rem;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">작은 도서관의 도서 시스템의<br /> <b>자유 게시판 게시물</b>을 관리합니다.</p>
                            ...
                            <div class="card-group">
                                <div class="card" style="width: 18rem;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">작은 도서관의 도서 시스템의<br /> <b>전체 회원 목록</b>을 확인합니다.</p>
        ...
        <footer class="py-5 bg-dark">
            <div class="container px-4 px-lg-5">
                <p class="m-0 text-center text-white"> &copy; 작은 도서관 </p>
            </div>
        </footer>
        <!-- Bootstrap core JS-->
